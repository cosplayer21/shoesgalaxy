...
if ( ! function_exists( 'customizer_library_get_font_choices' ) ) :
	...
	function customizer_library_get_all_fonts() {
		$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'galepro' ) ) ) );
		$standard_fonts = customizer_library_get_standard_fonts();
		$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'galepro' ) ) ) );
...
if ( ! function_exists( 'customizer_library_get_google_font_subsets' ) ) :
	...
	function customizer_library_get_google_font_subsets() {
		return array(
			'all'          => __( 'All', 'galepro' ),
			'cyrillic'     => __( 'Cyrillic', 'galepro' ),
			'cyrillic-ext' => __( 'Cyrillic Extended', 'galepro' ),
			'devanagari'   => __( 'Devanagari', 'galepro' ),
			'greek'        => __( 'Greek', 'galepro' ),
			'greek-ext'    => __( 'Greek Extended', 'galepro' ),
			'khmer'        => __( 'Khmer', 'galepro' ),
			'latin'        => __( 'Latin', 'galepro' ),
			'latin-ext'    => __( 'Latin Extended', 'galepro' ),
			'vietnamese'   => __( 'Vietnamese', 'galepro' ),
		);
	}
endif;
...
if ( ! function_exists( 'customizer_library_get_standard_fonts' ) ) :
	...
	function customizer_library_get_standard_fonts() {
		return array(
			'serif'      => array(
				'label' => _x( 'Serif', 'font style', 'galepro' ),
				'stack' => 'Georgia,Times,"Times New Roman",serif',
			),
			'sans-serif' => array(
				'label' => _x( 'Sans Serif', 'font style', 'galepro' ),
				'stack' => '"Helvetica Neue",sans-serif',
			),
			'monospace'  => array(
				'label' => _x( 'Monospaced', 'font style', 'galepro' ),
